...
Drawing Layers provides import and export capabilities that allow you to export layer data to Excel for external editing, analysis, and standarization or backup purposes, as well as import updated layer data with change detection feature.
