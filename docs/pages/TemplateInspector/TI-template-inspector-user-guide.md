...
**Key Features:**
- Support for inspecting layers, line types, hatch styles, dimension styles, and text styles
- Depth scan of objects to find where they are used for batch modification
- Display of object usage status (used/not used) for deletion decisions
- Multi-selection batch actions to delete and reassign objects 