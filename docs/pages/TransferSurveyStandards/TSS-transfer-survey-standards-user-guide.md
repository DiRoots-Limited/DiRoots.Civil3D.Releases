...
<div class="centered-image">
  <img src="{{ '/assets/images/logos/transferSurveyStandardsLight.png' | relative_url }}" alt="Transfer Survey Standards Logo" width="200" style="display:block;margin:0 auto;">
</div>
