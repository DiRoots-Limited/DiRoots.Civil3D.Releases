...
**Key Features:**
- Transfer Point Description Keys from open and closed Civil 3D files
- Export and import to/from Excel for Point Description Keys and Figure Prefix DBs
- Edit values before setting them in files or before exporting them
- Comprehensive survey standards management capabilities 
