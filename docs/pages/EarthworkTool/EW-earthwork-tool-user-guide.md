...
**Key Features:**
- Full surface comparison for cut/fill analysis
- Multiple region surface calculations
- Topsoil stripping surface creation from existing surface
- Subgrade/base surface creation on delimited regions from proposed surface
- Total earthwork calculation across multiple surfaces
- Dynamic volume unit update (m³, yd³, ft³, acre-ft) 